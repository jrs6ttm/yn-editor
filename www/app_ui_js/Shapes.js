...
(function() {
    ...
    mxCellRenderer.prototype.defaultShapes['bpmn'] = ExtendedShape;
    ...
    if (typeof mxVertexHandler !== 'undefined') {
        ...
        // Handler (the yeller point at the top-right corner) for configurate the arc of the corner of a shape
        ...
        mxVertexHandler.prototype.createCustomHandles = function() {
            ...
            console.log(this.state.cell.getAttribute('type'));
