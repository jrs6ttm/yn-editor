...
Toolbar.prototype.init = function() {
	...
	var rawItems1 = ['undo', 'redo', 'delete', '-', 'actualSize', 'zoomIn', 'zoomOut', '-'];
	this.addItems(rawItems1);

	var rawItems2 = ['formatPanel', '-'];
	if (this.editorUi.format != null) {
		var items2 = this.addItems(rawItems2);
		this.editorUi.addListener('formatWidthChanged', mxUtils.bind(this, function() {
			items2[0].style.background = (this.editorUi.actions.get('formatPanel').selectedCallback()) ? scolor : ucolor;
		}));
	}
