...
Sidebar.prototype.init = function() {
    ...
    if(mxUi === 'process_design'){
        this.addBpmnEventsPalette(true);
		this.addBpmnSubprocessesPalette(true);
        this.addBpmnTasksPalette(true);
		//160906 fz 去掉网关显示（课程组要求）
        //this.addBpmnGatewaysPalette(true);
        this.addBpmnParticipantsPalette(true);
        this.addBpmnOthersPalette(true);
    }else if(mxUi === 'task_design'){
        this.addTypicalTaskPalette(true);
    }else if(mxUi === 'subject_design'){
		this.addSubjectTaskPalette(true);
	...
	//this.addStencilPalette('flowchart', mxResources.get('flowcharts'), dir + '/flowchart.xml',
	//	';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2');
...
Sidebar.prototype.addGeneralPalette = function(expand) {
	...
	this.addPalette('general', mxResources.get('general'), (expand != null) ? expand : true, mxUtils.bind(this, function(content) {
		...
		var ecCell = doc.createElement('ecCell');
		content.appendChild(this.createVertexTemplate('whiteSpace=wrap;html=1;', 120, 60, ecCell, 'Rectangle', true));
...
/**
 * Adds the typical task palette to the sidebar.
 */
Sidebar.prototype.addTypicalTaskPalette = function(expand) {
    // Rearranged based on usage data from
    this.addPalette('representationElem', mxResources.get('representationElem'), (expand != null) ? expand : true, mxUtils.bind(this, function(content) {

        //var doc = mxUtils.createXmlDocument();
        //var ecCell = doc.createElement('ecCell');
        content.appendChild(this.createEcVertexTemplate('swimlane;swimlaneFillColor=#E6E6E6;whiteSpace=wrap;html=1;rounded=1;strokeColor=#00729F;fillColor=none;', 200, 500, mxResources.get('taskGroup'), mxResources.get('taskGroupDes'), true, null, 'task_design.taskGroup'));
        content.appendChild(this.createEcVertexTemplate('whiteSpace=wrap;html=1;rounded=1;strokeColor=#00729F;', 150, 60, mxResources.get('subTask'), mxResources.get('subTaskDes'), true, null, 'task_design.subTask'));
    }));
};
/**
 * Adds the Subject_design task palette to the sidebar.
 */
Sidebar.prototype.addSubjectTaskPalette = function(expand) {
    this.addPalette('tool', mxResources.get('tool'), (expand != null) ? expand : true, mxUtils.bind(this, function(content) {

        //var doc = mxUtils.createXmlDocument();
        //var ecCell = doc.createElement('ecCell');
		content.appendChild(this.createEcVertexTemplate('shape=bpmn;rounded=1;html=1;whiteSpace=wrap;align=left;strokeColor=#177D36', 150, 30, '章节名', '章节框（绿色、细）', true, false, 'bpmn.task'));
		content.appendChild(this.createEcVertexTemplate('shape=bpmn;rounded=1;html=1;whiteSpace=wrap;align=left;strokeColor=#177D36;strokeWidth=3;', 150, 30, '章节名', '章节框（绿色、加粗）', true, false, 'bpmn.task'));
		content.appendChild(this.createEcVertexTemplate('shape=bpmn;rounded=1;html=1;whiteSpace=wrap;align=left;strokeColor=#3165BB', 150, 30, '章节名', '章节框（蓝色、细）', true, false, 'bpmn.task'));
		content.appendChild(this.createEcVertexTemplate('shape=bpmn;rounded=1;html=1;whiteSpace=wrap;align=left;strokeColor=#3165BB;strokeWidth=3;', 150, 30, '章节名', '章节框（蓝色、加粗）', true, false, 'bpmn.task'));
		var assoc = new mxCell('', new mxGeometry(0, 0, 0, 0), 'endArrow=block;endFill=1;endSize=6;html=1;strokeColor=#B3B3B3;strokeWidth=3;');
		...
		assoc.edge = true;
		content.appendChild(this.createEdgeTemplateFromCells([assoc], 100, 0, mxResources.get('SequenceFlow')+'（粗）', true));
		var assoc = new mxCell('', new mxGeometry(0, 0, 0, 0), 'endArrow=block;endFill=1;endSize=6;html=1;strokeColor=#B3B3B3;strokeWidth=2;');
		assoc.geometry.setTerminalPoint(new mxPoint(0, 0), true);
		assoc.geometry.setTerminalPoint(new mxPoint(100, 0), false);
		assoc.geometry.relative = true;
		assoc.edge = true;
		content.appendChild(this.createEdgeTemplateFromCells([assoc], 100, 0, mxResources.get('SequenceFlow')+'（中）', true));
		var assoc = new mxCell('', new mxGeometry(0, 0, 0, 0), 'endArrow=block;endFill=1;endSize=6;html=1;strokeColor=#B3B3B3;strokeWidth=1;');
		assoc.geometry.setTerminalPoint(new mxPoint(0, 0), true);
		assoc.geometry.setTerminalPoint(new mxPoint(100, 0), false);
		assoc.geometry.relative = true;
		assoc.edge = true;
		content.appendChild(this.createEdgeTemplateFromCells([assoc], 100, 0, mxResources.get('SequenceFlow')+'（细）', true));
		var assoc = new mxCell('', new mxGeometry(0, 0, 0, 0), 'endArrow=block;endFill=1;endSize=6;html=1;strokeColor=#FF0000;strokeWidth=3;');
		assoc.geometry.setTerminalPoint(new mxPoint(0, 0), true);
		assoc.geometry.setTerminalPoint(new mxPoint(100, 0), false);
		assoc.geometry.relative = true;
		assoc.edge = true;
		content.appendChild(this.createEdgeTemplateFromCells([assoc], 100, 0, mxResources.get('SequenceFlow')+'（红色）', true));
		//content.appendChild(this.createEcVertexTemplate('swimlane;swimlaneFillColor=#E6E6E6;whiteSpace=wrap;html=1;rounded=1;strokeColor=#00729F;fillColor=none;', 200, 500, mxResources.get('taskGroup'), mxResources.get('taskGroupDes'), true, null, 'task_design.taskGroup'));
        //content.appendChild(this.createEcVertexTemplate('whiteSpace=wrap;html=1;rounded=1;strokeColor=#00729F;', 150, 60, mxResources.get('subTask'), mxResources.get('subTaskDes'), true, null, 'task_design.subTask'));
    }));
};
...
Sidebar.prototype.addAdvancedPalette = function(dir, expand) {
	this.addPalette('advanced', mxResources.get('advanced'), (expand != null) ? expand : false, mxUtils.bind(this, function(content) {
		...
		this.graph.setLinkForCell(linkCell, 'https//');
...
Sidebar.prototype.addBpmnTasksPalette = function(expand) {
    this.addPalette('bpmn', mxResources.get('bpmnTasks'), (expand != null) ? expand : true, mxUtils.bind(this, function(content){

        //content.appendChild(this.createEcVertexTemplate('shape=bpmn;rounded=1;html=1;whiteSpace=wrap;', 120, 80, 'Task', 'Process', true, false, 'bpmn.task'));

        // user task
        var classCell = new mxCell(this.createEcDocNode(mxResources.get('UserTask'), 'bpmn.task.user'), new mxGeometry(0, 0, 120, 80), 'shape=bpmn;html=1;whiteSpace=wrap;rounded=1;fillColor=#99CCFF;');
        classCell.vertex = true;
        var classCell1 = new mxCell('', new mxGeometry(0, 0, 14, 14), 'html=1;shape=mxgraph.bpmn.user_task;selectable=0');
        classCell1.vertex = true;
        classCell1.geometry.relative = true;
        classCell1.geometry.offset = new mxPoint(7, 7);
        classCell.insert(classCell1);
        content.appendChild(this.createEcVertexTemplate([classCell], 120, 80, '', mxResources.get('UserTask'), true));

        // Send Task
        var classCell = new mxCell(this.createEcDocNode('Send Task', 'bpmn.task.use.send'), new mxGeometry(0, 0, 120, 80), 'shape=bpmn;html=1;whiteSpace=wrap;rounded=1;');
        classCell.vertex = true;
        var classCell1 = new mxCell('', new mxGeometry(0, 0, 20, 14), 'html=1;shape=message;fillColor=#000000;strokeColor=#ffffff;');
        classCell1.vertex = true;
        classCell1.geometry.relative = true;
        classCell1.geometry.offset = new mxPoint(7, 7);
        classCell.insert(classCell1);
        //content.appendChild(this.createEcVertexTemplate([classCell], 120, 80, '', 'Send Task', true));

        // Receive Task
        var classCell = new mxCell(this.createEcDocNode('Receive Task', 'bpmn.task.use.receive'), new mxGeometry(0, 0, 120, 80), 'shape=bpmn;html=1;whiteSpace=wrap;rounded=1;');
        classCell.vertex = true;
        ...
        classCell1.geometry.offset = new mxPoint(7, 7);
        classCell.insert(classCell1);
        //content.appendChild(this.createEcVertexTemplate([classCell], 120, 80, '', 'Receive Task', true));
 ...
 */
Sidebar.prototype.addBpmnSubprocessesPalette = function(expand) {
	this.addPalette('bpmn', mxResources.get('bpmnSubprocesses'), (expand != null) ? expand : true, mxUtils.bind(this, function(content){
		if(mxUi=='process_design'){
			var classCell = new mxCell(this.createEcDocNode('子任务', 'bpmn.subprocess.ectask'), new mxGeometry(0, 0, 530, 130), 'shape=swimlane;html=1;horizontal=1;swimlaneFillColor=white;fillColor=#CCCCCC;swimlaneLine=0;startSize=20;rounded=1;arcSize=14;strokeWidth=2');
			classCell.vertex = true;
			classCell.geometry.alternateBounds = new mxRectangle(0, 0, 120, 50);
			var classCell1 = new mxCell('', new mxGeometry(0.5, 1, 14, 14), 'html=1;shape=plus;selectable=0');
			classCell1.vertex = true;
			classCell1.geometry.relative = true;
			classCell1.geometry.offset = new mxPoint(-7, -15);
			classCell.insert(classCell1);
			content.appendChild(this.createEcVertexTemplate([classCell], 530, 130, '', '子任务', true));
			return;
		}

        //var classCell = new mxCell(this.createEcDocNode('Sub-Process', 'bpmn.subprocess'), new mxGeometry(0, 0, 120, 80), 'shape=bpmn;html=1;whiteSpace=wrap;rounded=1');
        //classCell.vertex = true;
        ...
        //classCell.insert(classCell1);
        //content.appendChild(this.createEcVertexTemplate([classCell], 120, 80, '', 'Sub-Process', true));


        var classCell = new mxCell(this.createEcDocNode(mxResources.get('learningSitu'), 'bpmn.subprocess.call'), new mxGeometry(0, 0, 120, 80), 'shape=bpmn;html=1;whiteSpace=wrap;rounded=1;strokeWidth=3');
        classCell.vertex = true;
        var classCell1 = new mxCell('', new mxGeometry(0.5, 1, 14, 14), 'html=1;shape=plus;');
        classCell1.vertex = true;
        classCell1.geometry.relative = true;
        classCell1.geometry.offset = new mxPoint(-7, -14);
        classCell.insert(classCell1);
        content.appendChild(this.createEcVertexTemplate([classCell], 120, 80, '', mxResources.get('learningSitu'), true));


        //var classCell = new mxCell(this.createEcDocNode('Event\nSub-Process', 'bpmn.subprocess.event'), new mxGeometry(0, 0, 120, 80), 'shape=bpmn;html=1;whiteSpace=wrap;rounded=1;dashed=1;dashPattern=2 2');
        //classCell.vertex = true;
        //var classCell1 = new mxCell('', new mxGeometry(0.5, 1, 14, 14), 'html=1;shape=plus;');
        //classCell1.vertex = true;
        //classCell1.geometry.relative = true;
        //classCell1.geometry.offset = new mxPoint(-7, -14);
        //classCell.insert(classCell1);
        //content.appendChild(this.createEcVertexTemplate([classCell], 120, 80, '', 'Event Sub-Process', true));
        //
        //var classCell = new mxCell(this.createEcDocNode('Transaction', 'bpmn.subprocess.transaction'), new mxGeometry(0, 0, 120, 80), 'shape=bpmn;rounded=1;html=1;whiteSpace=wrap;double=1;');
        //classCell.vertex = true;
        //var classCell1 = new mxCell('', new mxGeometry(0.5, 1, 14, 14), 'html=1;shape=plus;');
        //classCell1.vertex = true;
        //classCell1.geometry.relative = true;
        //classCell1.geometry.offset = new mxPoint(-7, -14);
        //classCell.insert(classCell1);
        //content.appendChild(this.createEcVertexTemplate([classCell], 120, 80, '', 'Transaction', true));



		//var classCell = new mxCell(this.createEcDocNode('Looped\nSub-Process'), new mxGeometry(0, 0, 120, 80), 'shape=bpmn;html=1;whiteSpace=wrap;rounded=1');
		//classCell.vertex = true;
        ...
        //
        //
		//var classCell = new mxCell(this.createEcDocNode('Process'), new mxGeometry(0, 0, 120, 80), 'shape=bpmn;html=1;whiteSpace=wrap;rounded=1;');
		//classCell.vertex = true;
		...
		//classCell.insert(classCell1);
		//content.appendChild(this.createEcVertexTemplate([classCell], 120, 95, '', 'Attached Timer Event 1 ', true));
		//
		//var classCell = new mxCell(this.createEcDocNode('Process'), new mxGeometry(0, 0, 120, 80), 'shape=bpmn;html=1;whiteSpace=wrap;rounded=1;');
		//classCell.vertex = true;
		...
		//classCell.insert(classCell1);
		//
		//content.appendChild(this.createEcVertexTemplate([classCell], 135, 80, '', 'Attached Timer Event 2', true));

	}));
};

Sidebar.prototype.addBpmnParticipantsPalette = function(expand) {
    this.addPalette('bpmn', mxResources.get('bpmnParticipants'), (expand != null) ? expand : true, mxUtils.bind(this, function(content){

        content.appendChild(this.createEcVertexTemplate('swimlane;html=1;horizontal=0;swimlaneFillColor=white;startSize=20', 320, 240, mxResources.get('pool'), mxResources.get('pool'), true, false, 'bpmn.participant.pool'));
        //content.appendChild(this.createEcVertexTemplate('swimlane;html=1;horizontal=0;swimlaneFillColor=white;swimlaneLine=0;', 300, 120, mxResources.get('lane'), mxResources.get('lane'), true, false, 'bpmn.participant.lane'));

    }));
};

Sidebar.prototype.addBpmnGatewaysPalette = function(expand) {
	this.addPalette('bpmn', mxResources.get('bpmnGateways'), (expand != null) ? expand : true, mxUtils.bind(this, function(content){
		var commentStyle = "shape=mxgraph.bpmn.shape;html=1;verticalLabelPosition=bottom;verticalAlign=top;perimeter=rhombusPerimeter;background=gateway;";

		content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=none;symbol=exclusiveGw;', 50, 50, '', mxResources.get('ExclusiveGateway'), false, false, 'bpmn.gateway.exclusive'));
		content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=none;symbol=parallelGw;', 50, 50, '', mxResources.get('ParallelGateway'), false, false, 'bpmn.gateway.parallel'));
		content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=end;symbol=general;', 50, 50, '', mxResources.get('InclusiveGateway'), false, false, 'bpmn.gateway.inclusive'));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=none;symbol=complexGw;', 50, 50, '', 'Complex Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=standard;symbol=general;', 50, 50, '', 'General Start Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=throwing;symbol=general;', 50, 50, '', 'General End Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=end;symbol=general;', 50, 50, '', 'Exclusive Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=standard;symbol=message;', 50, 50, '', 'Message Standard Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=eventInt;symbol=message;', 50, 50, '', 'Message Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=eventNonint;symbol=message;', 50, 50, '', 'Message Non-Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=catching;symbol=message;', 50, 50, '', 'Message Catching Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=boundInt;symbol=message;', 50, 50, '', 'Message Boundary Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=boundNonint;symbol=message;', 50, 50, '', 'Message Boundary Non-Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=throwing;symbol=message;', 50, 50, '', 'Message Throwing Gateway Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=end;symbol=message;', 50, 50, '', 'Message End Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=standard;symbol=timer;', 50, 50, '', 'Timer Standard Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=eventInt;symbol=timer;', 50, 50, '', 'Timer Interrupting  Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=eventNonint;symbol=timer;', 50, 50, '', 'Timer Non-Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=catching;symbol=timer;', 50, 50, '', 'Timer Catching Gateway Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=boundInt;symbol=timer;', 50, 50, '', 'Timer Boundary Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=boundNonint;symbol=timer;', 50, 50, '', 'Timer Boundary Non-Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=eventInt;symbol=escalation;', 50, 50, '', 'Escalation Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=eventNonint;symbol=escalation;', 50, 50, '', 'Escalation Non-Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=boundInt;symbol=escalation;', 50, 50, '', 'Escalation Boundary Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=boundNonint;symbol=escalation;', 50, 50, '', 'Escalation Boundary Non-Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=throwing;symbol=escalation;', 50, 50, '', 'Escalation Throwing Gateway Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=end;symbol=escalation;', 50, 50, '', 'Escalation End Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=standard;symbol=conditional;', 50, 50, '', 'Conditional Standard Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=eventInt;symbol=conditional;', 50, 50, '', 'Conditional Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=eventNonint;symbol=conditional;', 50, 50, '', 'Conditional Non-Interrupting Gateway Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=catching;symbol=conditional;', 50, 50, '', 'Conditional Catching Gateway Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=boundInt;symbol=conditional;', 50, 50, '', 'Conditional Boundary Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=boundNonint;symbol=conditional;', 50, 50, '', 'Conditional Boundary Non-Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=catching;symbol=link;', 50, 50, '', 'Link Catching Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=throwing;symbol=link;', 50, 50, '', 'Link Throwing Gateway Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=eventInt;symbol=error;', 50, 50, '', 'Error Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=boundInt;symbol=error;', 50, 50, '', 'Error Boundary Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=end;symbol=error;', 50, 50, '', 'Error End Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=boundInt;symbol=cancel;', 50, 50, '', 'Cancel Boundary Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=end;symbol=cancel;', 50, 50, '', 'Cancel End Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=eventInt;symbol=compensation;', 50, 50, '', 'Compensation Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=boundInt;symbol=compensation;', 50, 50, '', 'Compensation Boundary Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=throwing;symbol=compensation;', 50, 50, '', 'Compensation Throwing Gateway Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=end;symbol=compensation;', 50, 50, '', 'Compensation End Gateway Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=standard;symbol=signal;', 50, 50, '', 'Signal Standard Gateway Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=eventInt;symbol=signal;', 50, 50, '', 'Signal Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=eventNonint;symbol=signal;', 50, 50, '', 'Signal Non-Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=catching;symbol=signal;', 50, 50, '', 'Signal Catching Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=boundInt;symbol=signal;', 50, 50, '', 'Signal Boundary Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=boundNonint;symbol=signal;', 50, 50, '', 'Signal Boundary Non-Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=throwing;symbol=signal;', 50, 50, '', 'Signal Throwing Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=end;symbol=signal;', 50, 50, '', 'Signal End Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=standard;symbol=multiple;', 50, 50, '', 'Multiple Standard Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=eventInt;symbol=multiple;', 50, 50, '', 'Multiple Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=eventNonint;symbol=multiple;', 50, 50, '', 'Multiple Non-Interrupting Gateway', false));
		content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=catching;symbol=multiple;', 50, 50, '', mxResources.get('MultipleCatchingGateway'), false, false, 'bpmn.gateway.event_based'));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=boundInt;symbol=multiple;', 50, 50, '', 'Multiple Boundary Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=boundNonint;symbol=multiple;', 50, 50, '', 'Multiple Boundary Non-Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=throwing;symbol=multiple;', 50, 50, '', 'Multiple Throwing Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=end;symbol=multiple;', 50, 50, '', 'Multiple End Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=standard;symbol=parallelMultiple;', 50, 50, '', 'Parallel Multiple Standard Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=eventInt;symbol=parallelMultiple;', 50, 50, '', 'Parallel Multiple Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=eventNonint;symbol=parallelMultiple;', 50, 50, '', 'Parallel Multiple Non-Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=catching;symbol=parallelMultiple;', 50, 50, '', 'Parallel Multiple Catching Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=boundInt;symbol=parallelMultiple;', 50, 50, '', 'Parallel Multiple Boundary Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=boundNonint;symbol=parallelMultiple;', 50, 50, '', 'Parallel Multiple Boundary Non-Interrupting Gateway', false));
		//content.appendChild(this.createEcVertexTemplate(commentStyle + 'outline=end;symbol=terminate;', 50, 50, '', 'Terminate Gateway', false));


	}));
};
Sidebar.prototype.addBpmnEventsPalette = function(expand) {
	this.addPalette('bpmn', mxResources.get('bpmnEvents'), (expand != null) ? expand : true, mxUtils.bind(this, function(content){
		var commonStyle = "shape=mxgraph.bpmn.shape;html=1;verticalLabelPosition=bottom;verticalAlign=top;perimeter=ellipsePerimeter;";
			content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=standard;symbol=general;fillColor=#99FFCC",             50, 50, "", mxResources.get('GeneralStart'),                 false, false, 'bpmn.gateway.general.start'));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=throwing;symbol=general;",             50, 50, "", "General Intermediate",                        false));
			content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=end;symbol=general;fillColor=#FF3333",                  50, 50, "", mxResources.get('GeneralEnd'),                   false, false, 'bpmn.gateway.general.end'));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=standard;symbol=message;",             50, 50, "", "Message Standard",                            false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=eventInt;symbol=message;",             50, 50, "", "Message Interrupting",                        false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=eventNonint;symbol=message;",          50, 50, "", "Message Non-Interrupting",                    false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=catching;symbol=message;",             50, 50, "", "Message Catching",                            false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=boundInt;symbol=message;",             50, 50, "", "Message Boundary Interrupting",               false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=boundNonint;symbol=message;",          50, 50, "", "Message Boundary Non-Interrupting",           false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=throwing;symbol=message;",             50, 50, "", "Message Throwing",                            false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=end;symbol=message;",                  50, 50, "", "Message End",                                 false, false, 'bpmn.gateway.message.end'));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=standard;symbol=timer;",               50, 50, "", "Timer Standard",                              false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=eventInt;symbol=timer;",               50, 50, "", "Timer Interrupting",                          false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=eventNonint;symbol=timer;",            50, 50, "", "Timer Non-Interrupting",                      false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=catching;symbol=timer;",               50, 50, "", "Timer Catching",                              false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=boundInt;symbol=timer;",               50, 50, "", "Timer Boundary Interrupting",                 false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=boundNonint;symbol=timer;",            50, 50, "", "Timer Boundary Non-Interrupting",             false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=eventInt;symbol=escalation;",          50, 50, "", "Escalation Interrupting",                     false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=eventNonint;symbol=escalation;",       50, 50, "", "Escalation Non-Interrupting",                 false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=boundInt;symbol=escalation;",          50, 50, "", "Escalation Boundary Interrupting",            false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=boundNonint;symbol=escalation;",       50, 50, "", "Escalation Boundary Non-Interrupting",        false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=throwing;symbol=escalation;",          50, 50, "", "Escalation Throwing",                         false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=end;symbol=escalation;",               50, 50, "", "Escalation End",                              false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=standard;symbol=conditional;",         50, 50, "", "Conditional Standard",                        false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=eventInt;symbol=conditional;",         50, 50, "", "Conditional Interrupting",                    false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=eventNonint;symbol=conditional;",      50, 50, "", "Conditional Non-Interrupting",                false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=catching;symbol=conditional;",         50, 50, "", "Conditional Catching",                        false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=boundInt;symbol=conditional;",         50, 50, "", "Conditional Boundary Interrupting",           false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=boundNonint;symbol=conditional;",      50, 50, "", "Conditional Boundary Non-Interrupting",       false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=catching;symbol=link;",                50, 50, "", "Link Catching",                               false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=throwing;symbol=link;",                50, 50, "", "Link Throwing",                               false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=eventInt;symbol=error;",               50, 50, "", "Error Interrupting",                          false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=boundInt;symbol=error;",               50, 50, "", "Error Boundary Interrupting",                 false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=end;symbol=error;",                    50, 50, "", "Error End",                                   false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=boundInt;symbol=cancel;",              50, 50, "", "Cancel Boundary Interrupting",                false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=end;symbol=cancel;",                   50, 50, "", "Cancel End",                                  false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=eventInt;symbol=compensation;",        50, 50, "", "Compensation Interrupting",                   false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=boundInt;symbol=compensation;",        50, 50, "", "Compensation Boundary Interrupting",          false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=throwing;symbol=compensation;",        50, 50, "", "Compensation Throwing",                       false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=end;symbol=compensation;",             50, 50, "", "Compensation End",                            false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=standard;symbol=signal;",              50, 50, "", "Signal Standard",                             false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=eventInt;symbol=signal;",              50, 50, "", "Signal Interrupting",                         false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=eventNonint;symbol=signal;",           50, 50, "", "Signal Non-Interrupting",                     false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=catching;symbol=signal;",              50, 50, "", "Signal Catching",                             false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=boundInt;symbol=signal;",              50, 50, "", "Signal Boundary Interrupting",                false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=boundNonint;symbol=signal;",           50, 50, "", "Signal Boundary Non-Interrupting",            false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=throwing;symbol=signal;",              50, 50, "", "Signal Throwing",                             false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=end;symbol=signal;",                   50, 50, "", "Signal End",                                  false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=standard;symbol=multiple;",            50, 50, "", "Multiple Standard",                           false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=eventInt;symbol=multiple;",            50, 50, "", "Multiple Interrupting",                       false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=eventNonint;symbol=multiple;",         50, 50, "", "Multiple Non-Interrupting",                   false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=catching;symbol=multiple;",            50, 50, "", "Multiple Catching",                           false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=boundInt;symbol=multiple;",            50, 50, "", "Multiple Boundary Interrupting",              false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=boundNonint;symbol=multiple;",         50, 50, "", "Multiple Boundary Non-Interrupting",          false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=throwing;symbol=multiple;",            50, 50, "", "Multiple Throwing",                           false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=end;symbol=multiple;",                 50, 50, "", "Multiple End",                                false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=standard;symbol=parallelMultiple;",    50, 50, "", "Parallel Multiple Standard",                  false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=eventInt;symbol=parallelMultiple;",    50, 50, "", "Parallel Multiple Interrupting",              false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=eventNonint;symbol=parallelMultiple;", 50, 50, "", "Parallel Multiple Non-Interrupting",          false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=catching;symbol=parallelMultiple;",    50, 50, "", "Parallel Multiple Catching",                  false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=boundInt;symbol=parallelMultiple;",    50, 50, "", "Parallel Multiple Boundary Interrupting",     false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=boundNonint;symbol=parallelMultiple;", 50, 50, "", "Parallel Multiple Boundary Non-Interrupting", false));
			//content.appendChild(this.createEcVertexTemplate(commonStyle + "outline=end;symbol=terminate;",                50, 50, "", "Terminate",                                   false));


	}));
};
Sidebar.prototype.addBpmnOthersPalette = function(expand) {
	this.addPalette('bpmn', mxResources.get('bpmnOthers'), (expand != null) ? expand : true, mxUtils.bind(this, function(content){

		//content.appendChild(this.createEcVertexTemplate('shape=hexagon;html=1;whiteSpace=wrap;perimeter=hexagonPerimeter;', 60, 50, '', 'Conversation', true));
		//content.appendChild(this.createEcVertexTemplate('shape=hexagon;html=1;whiteSpace=wrap;perimeter=hexagonPerimeter;strokeWidth=4', 60, 50, '', 'Call Conversation', true));

		//var classCell = new mxCell(this.createEcDocNode(''), new mxGeometry(0, 0, 60, 50), 'shape=hexagon;whiteSpace=wrap;html=1;perimeter=hexagonPerimeter;');
		//classCell.vertex = true;
		//var classCell1 = new mxCell('', new mxGeometry(0.5, 1, 14, 14), 'html=1;shape=plus;');
		//classCell1.vertex = true;
		//classCell1.geometry.relative = true;
		...
		//classCell.insert(classCell1);
        //
		//content.appendChild(this.createEcVertexTemplate([classCell], 60, 50, '', 'Sub-Conversation', true));

		var classCell = new mxCell(this.createEcDocNode('', 'bpmn.data.object'), new mxGeometry(0, 0, 40, 60), 'shape=note;whiteSpace=wrap;size=16;html=1;');
		classCell.vertex = true;
		...
		content.appendChild(this.createEcVertexTemplate([classCell], 40, 60, '', mxResources.get('DataObject'), true));

		//content.appendChild(this.createEcVertexTemplate('shape=datastore;whiteSpace=wrap;html=1;', 60, 60, '', 'Data Store', true, false, 'bpmn.data.store'));

		//var classCell = new mxCell(this.createEcDocNode(''), new mxGeometry(0, 0, 14, 14), 'shape=plus;html=1;');
		//classCell.connectable = false;
		//classCell.vertex = true;
        //
		//content.appendChild(this.createEcVertexTemplate([classCell], 14, 14, '', 'Sub-Process Marker', true));
        //
		//var classCell = new mxCell(this.createEcDocNode(''), new mxGeometry(0, 0, 14, 14), 'shape=mxgraph.bpmn.loop;html=1;');
		//classCell.connectable = false;
		//classCell.vertex = true;
        //
		//content.appendChild(this.createEcVertexTemplate([classCell], 14, 14, '', 'Loop Marker', true));
        //
		//var classCell = new mxCell('', new mxGeometry(0, 0, 14, 14), 'shape=parallelMarker;html=1;');
		//classCell.vertex = true;
        //
		//content.appendChild(this.createEcVertexTemplate([classCell], 14, 14, '', 'Parallel MI Marker', true));
        //
		//var classCell = new mxCell('', new mxGeometry(0, 0, 14, 14), 'shape=parallelMarker;direction=south;html=1;');
		//classCell.vertex = true;
        //
		//content.appendChild(this.createEcVertexTemplate([classCell], 14, 14, '', 'Sequential MI Marker', true));
        //
		//var classCell = new mxCell('', new mxGeometry(0, 0, 14, 14), 'shape=mxgraph.bpmn.ad_hoc;fillColor=#000000;html=1;');
		//classCell.connectable = false;
		//classCell.vertex = true;
        //
		//content.appendChild(this.createEcVertexTemplate([classCell], 14, 14, '', 'Ad Hoc Marker', true));
        //
		//var classCell = new mxCell('', new mxGeometry(0, 0, 14, 14), 'shape=mxgraph.bpmn.compensation;html=1;');
		//classCell.connectable = false;
		//classCell.vertex = true;
        //
		//content.appendChild(this.createEcVertexTemplate([classCell], 14, 14, '', 'Compensation Marker', true));
        //
        //
		...
		//classCell.vertex = true;
        //
		//content.appendChild(this.createEcVertexTemplate([classCell], 40, 30, '', 'Send Task', true));
        //
		//var classCell = new mxCell('', new mxGeometry(0, 0, 40, 30), 'shape=message;whiteSpace=wrap;html=1;');
		//classCell.vertex = true;
        //
		//content.appendChild(this.createEcVertexTemplate([classCell], 40, 30, '', 'Receive Task', true));
        //
		...
		//classCell.vertex = true;
        //
		//content.appendChild(this.createEcVertexTemplate([classCell], 14, 14, '', 'Manual Task', true));
        //
		//var classCell = new mxCell('', new mxGeometry(0, 0, 14, 14), 'shape=mxgraph.bpmn.business_rule_task;html=1;');
		//classCell.connectable = false;
		//classCell.vertex = true;
        //
		//content.appendChild(this.createEcVertexTemplate([classCell], 14, 14, '', 'Business Rule Task', true));
        //
		//var classCell = new mxCell('', new mxGeometry(0, 0, 14, 14), 'shape=mxgraph.bpmn.service_task;html=1;');
		//classCell.connectable = false;
		//classCell.vertex = true;
        //
		//content.appendChild(this.createEcVertexTemplate([classCell], 14, 14, '', 'Service Task', true));
        //
		//var classCell = new mxCell('', new mxGeometry(0, 0, 14, 14), 'shape=mxgraph.bpmn.script_task;html=1;');
		//classCell.connectable = false;
		//classCell.vertex = true;
        //
		//content.appendChild(this.createEcVertexTemplate([classCell], 14, 14, '', 'Script Task', true));
		...
		content.appendChild(this.createEdgeTemplateFromCells([assoc], 100, 0, mxResources.get('SequenceFlow'), true));

		var assoc = new mxCell(this.createEcDocNode(''), new mxGeometry(0, 0, 0, 0), 'startArrow=dash;startSize=8;endArrow=block;endFill=1;endSize=6;html=1;');
		assoc.geometry.setTerminalPoint(new mxPoint(0, 0), true);
		assoc.geometry.setTerminalPoint(new mxPoint(100, 0), false);
		assoc.geometry.relative = true;
		assoc.edge = true;

		//content.appendChild(this.createEcVertexTemplate([assoc], 100, 0, '', 'Default Flow', true));

		var assoc = new mxCell(this.createEcDocNode(''), new mxGeometry(0, 0, 0, 0), 'startArrow=diamondThin;startFill=0;startSize=14;endArrow=block;endFill=1;endSize=6;html=1;');
		assoc.geometry.setTerminalPoint(new mxPoint(0, 0), true);
		assoc.geometry.setTerminalPoint(new mxPoint(100, 0), false);
		assoc.geometry.relative = true;
		assoc.edge = true;

		//content.appendChild(this.createEcVertexTemplate([assoc], 100, 0, '', 'Conditional Flow', true));

		var assoc = new mxCell(this.createEcDocNode(''), new mxGeometry(0, 0, 0, 0), 'startArrow=oval;startFill=0;startSize=7;endArrow=block;endFill=0;endSize=10;dashed=1;html=1;');
		assoc.geometry.setTerminalPoint(new mxPoint(0, 0), true);
		assoc.geometry.setTerminalPoint(new mxPoint(100, 0), false);
		assoc.geometry.relative = true;
		assoc.edge = true;

		//content.appendChild(this.createEcVertexTemplate([assoc], 100, 0, '', 'Message Flow 1'));
		...
		//content.appendChild(this.createEcVertexTemplate([assoc], 100, 0, '', 'Message Flow 2', true));

		var assoc = new mxCell(this.createEcDocNode(''), new mxGeometry(0, 0, 0, 0), 'shape=link;html=1;');
		assoc.geometry.setTerminalPoint(new mxPoint(0, 0), true);
		assoc.geometry.setTerminalPoint(new mxPoint(100, 0), false);
		assoc.geometry.relative = true;
		assoc.edge = true;

		//content.appendChild(this.createEcVertexTemplate([assoc], 100, 0, '', 'Link', true));
	...
	return mxUtils.bind(this, function(graph, evt, target, x, y) {
		if (graph.isEnabled()) {
			...
			if (cells.length > 0) {
				...
				try {
					// !! creating a vertex on the editor
					x = Math.round(x + dx);
					y = Math.round(y + dy);
...
Sidebar.prototype.addClickHandler = function(elt, ds, cells) {
	...
	ds.mouseUp = mxUtils.bind(this, function(evt) {
		...
		if (mxUi === 'process_design' && (!this.editorUi.editor.fileId)) {
			this.editorUi.createSubCourse(function (fileData) {
				if (fileData) {
					me.editorUi.chooseTaskType();
				} else {
					var currentCells = graph.getSelectionCells();
					graph.removeCells(currentCells);
				}
			})
		}
		this.editorUi.chooseTaskType();
	});
};
 ...
 * Creates a drop handler for inserting the given cells.
 */
Sidebar.prototype.createVertexTemplate = function(style_cells, width, height, value, title, showLabel, showTitle) {

	//+-
	var cells;
	if(style_cells && "string" === typeof style_cells){
		cells = [new mxCell((value != null) ? value : '', new mxGeometry(0, 0, width, height), style_cells)];
		cells[0].vertex = true;
	} else{
		cells = style_cells;
	}
...
Sidebar.prototype.createEcVertexTemplate = function(style_cells, width, height, value, title, showLabel, showTitle, type) {
	var ecCell = this.createEcDocNode(value, type);
	return this.createVertexTemplate(style_cells, width, height, ecCell, title, showLabel, showTitle);
};
/**
 *
 * @param value
 * @returns {Object}
 */
Sidebar.prototype.createEcDocNode = function(value, type) {
	var ecCell = mxUtils.createXmlDocument().createElement('ecCell');
    ecCell.setAttribute('type', (type != null) ? type : '');
	ecCell.setAttribute('label', (value != null) ? value : '');
	ecCell.setAttribute('creator', JSON.stringify({"userName":userName,"userId":userId}));
	//ecCell.setAttribute('description', 'No description');
	return ecCell;
};
/**
 * Creates a drop handler for inserting the given cells.
...
Sidebar.prototype.addPalette = function(id, title, expanded, onInit) {
	...
	if (mxUi === 'subject_design'){
		div.style.background = '#e9f4e0';
		div.style.border = '1px solid #ABD58B';
	}
