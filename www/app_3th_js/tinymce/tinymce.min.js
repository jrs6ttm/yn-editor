...
!function (e, t) {
    ...
    r(l, [], function () {
        ...
        var b = /^\s*|\s*$/g, x = Array.isArray || function (e) {
        ...
        function n(e) {
            ...
            return i[e] ? i[e] : (l = t("id accesskey class dir lang style tabindex title"), c = t("address blockquote div dl fieldset form h1 h2 h3 h4 h5 h6 hr menu ol p pre table ul"), u = t("a abbr b bdo br button cite code del dfn em embed i iframe img input ins kbd label map noscript object q s samp script select small span strong sub sup textarea u var #text #comment"), "html4" != e && (l.push.apply(l, t("contenteditable contextmenu draggable dropzone hidden spellcheck translate")), c.push.apply(c, t("article aside details dialog figure header footer hgroup section nav")), u.push.apply(u, t("audio canvas command datalist mark meter output picture progress time wbr video ruby bdi keygen"))), "html5-strict" != e && (l.push("xml:lang"), h = t("acronym applet basefont big font strike tt"), u.push.apply(u, h), s(h, function (e) {
                ...
                r("input textarea", "placeholder"), r("a", "download"), r("link script img", "crossorigin"), r("iframe", "sandbox seamless allowfullscreen")), s(t("a form meter progress dfn"), function (e) {
        ...
        return function (a) {
            ...
            function V(t, n, r, i) {
                ...
                function d(e, t) {
                    var n, r;
                    if (e)r = j.getRng(!0), l(e) ? (t !== !1 && (r.setStartBefore(e), r.setEndBefore(e)), q.remove(e)) : (n = u(e), n.nodeValue.charAt(0) === Q && (n.deleteData(0, 1),
                    r.startContainer == n && r.startOffset > 0 && r.setStart(n, r.startOffset - 1), r.endContainer == n && r.endOffset > 0 && r.setEnd(n, r.endOffset - 1)), q.remove(e, 1)), j.setRng(r); else if (e = c(j.getStart()), !e)for (; e = q.get(g);)d(e, !1)
                }
        ...
        return function (i) {
            function o(o) {
                ...
                function C() {
                    ...
                    /^(OL|UL|LI)$/.test(n) && (z = "LI"), L = z ? y(z) : a.create("BR"), e(!0) && e() ? "LI" == n ? a.insertAfter(L, t()) : a.replace(L, O) : e(!0) ? "LI" == n ? (a.insertAfter(L, t()), L.appendChild(a.doc.createTextNode(" ")), L.appendChild(O)) : O.parentNode.insertBefore(L, O) : e() ? (a.insertAfter(L, t()), p(L)) : (O = t(), T = S.cloneRange(), T.setStartAfter(D), T.setEndAfter(O), P = T.extractContents(), "LI" == z && "LI" == P.firstChild.nodeName ? (L = P.firstChild, a.insertAfter(P, O)) : (a.insertAfter(P, O), a.insertAfter(L, O))), a.remove(D), g(L), c.add()
                }
                ...
                function k() {
                    L = /^(H[1-6]|PRE|FIGURE)$/.test(I) && "HGROUP" != F ? y(z) : y(), l.end_container_on_empty_block && h(O) && a.isEmpty(D) ? L = a.split(O, D) : a.insertAfter(L, D), g(L)
                }

                var S, T, R, A, B, D, M, H, L, P, O, I, F, z, W;
                if (S = s.getRng(!0), !o.isDefaultPrevented()) {
                    if (!S.collapsed)return void i.execCommand("Delete");
                    if (new t(a).normalize(S), A = S.startContainer, B = S.startOffset, z = (l.force_p_newlines ? "p" : "") || l.forced_root_block, z = z ? z.toUpperCase() : "", M = a.doc.documentMode, H = o.shiftKey, 1 == A.nodeType && A.hasChildNodes() && (W = B > A.childNodes.length - 1, A = A.childNodes[Math.min(B, A.childNodes.length - 1)] || A, B = W && 3 == A.nodeType ? A.nodeValue.length : 0), R = E(A)) {
                        if (c.beforeChange(), !a.isBlock(R) && R != a.getRoot())return void((!z || H) && w());
                        if ((z && !H || !z && H) && (A = x(A, B)), D = a.getParent(A, a.isBlock), O = D ? a.getParent(D.parentNode, a.isBlock) : null, I = D ? D.nodeName.toUpperCase() : "", F = O ? O.nodeName.toUpperCase() : "", "LI" != F || o.ctrlKey || (D = O, I = F), /^(LI|DT|DD)$/.test(I)) {
                            if (!z && H)return void w();
                            if (a.isEmpty(D))return void C()
                        }
                        if ("PRE" == I && l.br_in_pre !== !1) {
                            if (!H)return void w()
                        } else if (!z && !H && "LI" != I || z && H)return void w();
                        z && D === i.getBody() || (z = z || "P", b() ? k() : b(!0) ? (L = D.parentNode.insertBefore(y(), D), p(L), g(D)) : (T = S.cloneRange(), T.setEndAfter(D), P = T.extractContents(), _(P), L = P.firstChild, a.insertAfter(P, D), m(L), N(D), a.isEmpty(L) ? (a.remove(L), k()) : g(L)), a.setAttrib(L, "id", ""), i.fire("NewBlock", {newBlock: L}), c.add())
                    }
                }
            }
        ...
        return e.extend({
            init: function (e) {
                ...
                var t = this, n = e || [], r, i, o = "HTML标签：", a = t.classPrefix;
        ...
        var i = e.extend({
            init: function (e) {
                ...
                return o = e.settings.image, o ? (i = "none", "string" != typeof o && (o = window.getSelection ? o[0] : o[1]), o = " style=\"background-image: url('" + o + "')\"") : o = "", i = e.settings.icon ? r + "ico " + r + "i-" + i : "", e.aria("role", e.parent()instanceof n ? "menuitem" : "button"), '<div id="' + t + '" class="' + e.classes + '" tabindex="-1" aria-labelledby="' + t + '"><button id="' + t + '-open" role="presentation" type="button" tabindex="-1">' + (i ? '<i class="' + i + '"' + o + "></i>" : "") + (a ? (i ? "\xa0" : "") + e.encode(a) : "") + '</button></div>'
            }, postRender: function () {
                var e = this;
