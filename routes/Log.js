...
var routesForMyIndex = require('../node_modeles_ext/LoggerForNodeJs/myRoutes/myIndexRoute.js');

//封装的日志应用

//【步骤一】获得定义日志全局唯一对象
var objLogManager = require('../node_modeles_ext/LoggerForNodeJs/myLogManager/LogManager.js').ObjLogManager;
var FuncLogEntity = require('../node_modeles_ext/LoggerForNodeJs/myLogManager/LogManager.js').FuncLogEntity;
module.exports =function (app) {
    ...
    app.get('/log', function(req, res)
    {
        ...
        var curProcess = require("../node_modeles_ext/LoggerForNodeJs/myLogManager/ProcessInfo.js").GetCurProcess();
